...
error_reporting(0);
session_start();
$GLOBALS['restaurant'] = Banashankari;
?>
<head>
    <meta charset="utf-8">
            ...
            <div class="top-links">
                <div class="container">
                    <ul class="row links">
                        ...
                        <li class="col-xs-12 col-sm-4 link-item"><span>3</span><a href="#">Order and Pay on delivery</a></li>
                    </ul>
                </div>
            </div>
            <!-- end:Top links -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-7 col-md-7 col-lg-9">
                            <div class="bg-gray restaurant-entry">
                                <div class="row">
                                <?php $ress= mysqli_query($db,"select * from restaurant where location='$restaurant'");
