                ...
                <div class="container text-center hero-text font-white">
                    ...
                    <div class="banner-form">
                        <form class="form-inline">
                            ...
                            <button onclick="location.href='restaurants.php'" type="button" class="btn theme-btn btn-lg">Browse Restaurants</button>
                        </form>
                    </div>
                    <div class="steps">
                        ...
                        <div class="step-item step3">
                            ...
                            <h4><span>3. </span>Wait for delivery!</h4> </div>
                        <!-- end:Step -->
                    </div>
                    <!-- end:Steps -->
                </div>
                    ...
                    <div class="row how-it-works-solution">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col3">
                            <div class="step step-3">
                                ...
                                <h3>Delivery</h3>
                                <p>Get your food delivered! And enjoy your meal! Pay  on delivery</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                ...
                <div class="row top-footer">
                    ...
                    <div class="col-xs-12 col-sm-3 popular-locations color-gray">
                        ...
                        <ul>
                            <li><a href="restaurants_loc.php">Indiranagar</a> </li>
                            <li><a href="restaurants_loc.php">Koramangala</a> </li>
                            <li><a href="restaurants_loc.php">Jayanagar</a> </li>
                            <li><a href="restaurants_loc.php">Banashankari</a> </li>
                        </ul>
                    </div>
                </div>
                <!-- top footer ends -->
